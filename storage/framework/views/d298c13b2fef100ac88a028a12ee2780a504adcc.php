        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="<?php echo e(route('root')); ?>" class="logo logo-light">
                    <span class="logo-lg">
                        <img src="<?php echo e(URL::asset('/assets/front/assets/logoipsum.svg')); ?>" alt="" width="100">
                    </span>
                </a>
            </div>
    ...
    <div class="d-flex">
        ...
        <div class="dropdown d-inline-block">
            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                ...
                <img class="rounded-circle header-profile-user" src="<?php echo e(isset(Auth::user()->avatar) ? asset('/uploads/avatar').'/'.(Auth::user()->id).'/'.(Auth::user()->avatar) : asset('/assets/images/users/avatar-1.jpg')); ?>"
                    alt="Header Avatar">
            ...
            <div class="dropdown-menu dropdown-menu-end">
                <!-- item-->
                <a class="dropdown-item d-block" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target=".change-password"><span class="badge bg-success float-end">11</span><i class="bx bx-wrench font-size-16 align-middle me-1"></i> <span key="t-settings"><?php echo app('translator')->get('translation.Settings'); ?></span></a>
...
<?php /**PATH E:\work\xampp\htdocs\Laravel\payment\resources\views/admin/layouts/topbar.blade.php ENDPATH**/ ?>